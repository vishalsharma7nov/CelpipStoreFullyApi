...
public class ListeningTestPart2QuestionAdapter extends BaseAdapter{
    ...
    public ListeningTestPart2QuestionAdapter(Context c, List<ListeningTestPart2> listeningTestPart2) {
        this.c = c;
        this.listeningTestPart2 = listeningTestPart2;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        u6.setVisibility(GONE);
        u7.setVisibility(GONE);
        u8.setVisibility(GONE);
        c1.setText("Correct Answer = "+" option"+listeningTestPart2.get(position).getQ1_answer());
        c2.setText("Correct Answer = "+" option"+listeningTestPart2.get(position).getQ2_answer());
        c3.setText("Correct Answer = "+" option"+listeningTestPart2.get(position).getQ3_answer());
        c4.setText("Correct Answer = "+" option"+listeningTestPart2.get(position).getQ4_answer());
        c5.setText("Correct Answer = "+" option"+listeningTestPart2.get(position).getQ5_answer());
        ...
        final String[] questions_audio =  {listeningTestPart2.get(position).getQ1_audio(),listeningTestPart2.get(position).getQ2_audio(),listeningTestPart2.get(position).getQ3_audio(),listeningTestPart2.get(position).getQ4_audio(),listeningTestPart2.get(position).getQ5_audio(),null};
        final String[] question_option1 = {listeningTestPart2.get(position).getQ1_option1(),listeningTestPart2.get(position).getQ2_option1(),listeningTestPart2.get(position).getQ3_option1(),listeningTestPart2.get(position).getQ4_option1(),listeningTestPart2.get(position).getQ5_option1(), null};
        final String[] question_option2 = {listeningTestPart2.get(position).getQ1_option2(),listeningTestPart2.get(position).getQ2_option2(),listeningTestPart2.get(position).getQ3_option2(),listeningTestPart2.get(position).getQ4_option2(),listeningTestPart2.get(position).getQ5_option2(), null};
        final String[] question_option3 = {listeningTestPart2.get(position).getQ1_option3(),listeningTestPart2.get(position).getQ2_option3(),listeningTestPart2.get(position).getQ3_option3(),listeningTestPart2.get(position).getQ4_option3(),listeningTestPart2.get(position).getQ5_option3(), null};
        final String[] question_option4 = {listeningTestPart2.get(position).getQ1_option4(),listeningTestPart2.get(position).getQ2_option4(),listeningTestPart2.get(position).getQ3_option4(),listeningTestPart2.get(position).getQ4_option4(),listeningTestPart2.get(position).getQ5_option4(), null};
        ...
        b2NextQuestion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b2NextQuestion.setVisibility(GONE);
        ...
        b3NextQuestion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b3NextQuestion.setVisibility(GONE);
        ...
        b4NextQuestion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b4NextQuestion.setVisibility(GONE);
        ...
        b5NextQuestion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b5NextQuestion.setVisibility(GONE);
        ...
        b6NextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String urlForSubmittingOptions = "http://demo.celpip.biz/api/lsPart2Submit?token="+tokenCode+"&q1_response="+userAnswerQuestion1+"&q2_response="+userAnswerQuestion2+"&q3_response="+userAnswerQuestion3+"&q4_response="+userAnswerQuestion4+"&q5_response="+userAnswerQuestion5+"&memberid="+member_id;
