package com.celpipstore.Adapter.ListeningTestAdapter.TotalTest;
...
public class ListeningTotalTestAdapter extends BaseAdapter{

    protected Context c;
    protected List<TotalTest> totalTests;

    public ListeningTotalTestAdapter(Context c, List<TotalTest> totalTests)
    {
        this.c=c;
