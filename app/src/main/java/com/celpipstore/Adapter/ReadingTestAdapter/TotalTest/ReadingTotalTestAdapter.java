package com.celpipstore.Adapter.ReadingTestAdapter.TotalTest;
...
public class ReadingTotalTestAdapter extends BaseAdapter{

    private Context c;
    private List<TotalTest> totalTests;

    public ReadingTotalTestAdapter(Context c, List<TotalTest> totalTests)
    {
        this.c=c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent = new Intent(c, ReadingTestListActivity.class);
