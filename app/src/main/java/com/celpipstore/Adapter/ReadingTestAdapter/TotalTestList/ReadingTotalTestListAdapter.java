package com.celpipstore.Adapter.ReadingTestAdapter.TotalTestList;
...
import com.celpipstore.CelpipTests.ReadingTest.ReadingTestQuestionActivity;

import java.util.List;


public class ReadingTotalTestListAdapter extends BaseAdapter{

    private Context c;
    private List<TotalTestList> totalTestLists;
    public ReadingTotalTestListAdapter(Context c, List<TotalTestList> totalTestLists)
    {
        this.c=c;
    ...
    private void connectionChecker(int position) {
        ...
        {
            Intent intent = new Intent(c, ReadingTestQuestionActivity.class);
