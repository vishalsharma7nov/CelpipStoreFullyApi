...
public class SpeakingTestPart4Adapter extends BaseAdapter{
    private Context c;
    private List<SpeakingTestPart3> speakingTestPart3;

    public SpeakingTestPart4Adapter(Context c, List<SpeakingTestPart3> practiceTestSpeaking) {
        this.c = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Glide .with(c)
              .load("http://demo.celpip.biz/uploads/speaking_part4/"+speakingTestPart3.get(position).getQ1_image())
