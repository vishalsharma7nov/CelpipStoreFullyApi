...
public class SpeakingTestPart5Adapter extends BaseAdapter{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Glide .with(c)
              .load("http://demo.celpip.biz/uploads/part2_listening/"+speakingTestPart5.get(position).getQ1_image())
              .into(question1_image);
        Glide .with(c)
                .load("http://demo.celpip.biz/uploads/part2_listening/"+speakingTestPart5.get(position).getQ1_image2())
