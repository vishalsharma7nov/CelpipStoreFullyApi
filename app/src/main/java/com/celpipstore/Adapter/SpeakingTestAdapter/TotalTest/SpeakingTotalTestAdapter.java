package com.celpipstore.Adapter.SpeakingTestAdapter.TotalTest;
...
import com.celpipstore.CelpipTests.SpeakingTest.SpeakingTestListActivity;
...
public class SpeakingTotalTestAdapter extends BaseAdapter{

    protected Context c;
    protected List<TotalTest> totalTests;

    public SpeakingTotalTestAdapter(Context c, List<TotalTest> totalTests)
    {
        this.c=c;
