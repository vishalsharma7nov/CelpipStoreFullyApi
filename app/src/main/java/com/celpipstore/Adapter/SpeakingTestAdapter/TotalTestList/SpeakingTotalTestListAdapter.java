package com.celpipstore.Adapter.SpeakingTestAdapter.TotalTestList;
...
import com.celpipstore.CelpipTests.SpeakingTest.SpeakingTestQuestionActivity;
...
public class SpeakingTotalTestListAdapter extends BaseAdapter{

    Context c;
    List<TotalTestList> totalTestLists;
    public SpeakingTotalTestListAdapter(Context c, List<TotalTestList> totalTestLists)
    {
        this.c=c;
    ...
    private void connectionChecker(int position) {
        ...
        {
            Intent intent = new Intent(c, SpeakingTestQuestionActivity.class);
