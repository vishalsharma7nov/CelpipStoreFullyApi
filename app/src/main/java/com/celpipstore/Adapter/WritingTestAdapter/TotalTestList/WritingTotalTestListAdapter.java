package com.celpipstore.Adapter.WritingTestAdapter.TotalTestList;
...
public class WritingTotalTestListAdapter extends BaseAdapter{

    Context c;
    List<TotalTestList> totalTestLists;
    public WritingTotalTestListAdapter(Context c, List<TotalTestList> totalTestLists)
    {
        this.c=c;
    ...
    private void connectionChecker(int position) {
        ...
        {
            Intent intent = new Intent(c, WritingTestQuestionActivity.class);
