...
import com.celpipstore.CelpipTests.ReadingTest.ReadingTestListActivity;
import com.celpipstore.CelpipTests.WritingTest.WritingTestListActivity;
...
public class WritingTotalTestAdapter extends BaseAdapter{

    private Context c;
    private List<TotalTest> totalTests;

    public WritingTotalTestAdapter(Context c, List<TotalTest> totalTests)
    {
        this.c=c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent = new Intent(c, WritingTestListActivity.class);
