...
import com.celpipstore.Adapter.ReadingTestAdapter.TotalTestList.ReadingTotalTestListAdapter;
...
public class ReadingTestListActivity extends AppCompatActivity {
                ...
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (abc !=1 )
                            {
                                Toast.makeText(ReadingTestListActivity.this, "NO TEST IS AVAILABLE RIGHT NOW!!", Toast.LENGTH_SHORT).show();
                            }
                            else if (abc == 1)
                            {
                                loading.dismiss();
                                showJSON(response);
                                Toast.makeText(getApplicationContext(), "WELCOME TO READING TEST!!", Toast.LENGTH_SHORT).show();
                            }
    ...
    private void showJSON(String json) {
        ...
        ReadingTotalTestListAdapter ca = new ReadingTotalTestListAdapter(this,totalTestLists);
