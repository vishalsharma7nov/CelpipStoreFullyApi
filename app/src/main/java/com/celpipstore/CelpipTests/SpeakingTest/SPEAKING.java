                ...
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            {
                                loading.dismiss();
                                Toast.makeText(SPEAKING.this, "TEST NOT AVAILABLE RIGHT NOW!!", Toast.LENGTH_SHORT).show();
                            }
                            else if (abc == 1)
                            {
                                loading.dismiss();
                                showJSON(response);
                                Toast.makeText(getApplicationContext(), "WELCOME TO SPEAKING TEST SECTION!!", Toast.LENGTH_SHORT).show();
                            }
