...
public class VOCABULARY_TESTS extends AppCompatActivity {
    ...
    private void sendRequest() {
        ...
        StringRequest stringRequest = new StringRequest("http://demo.celpip.biz/api/vocabularyLevels",
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            {
                                loading.dismiss();
                                Toast.makeText(VOCABULARY_TESTS.this, "VOCABULARY TESTS NOT AVAILABLE RIGHT NOW!!", Toast.LENGTH_SHORT).show();
                            }
                            else if (abc == 1)
                            {
                                loading.dismiss();
                                showJSON(response);
                                Toast.makeText(getApplicationContext(), "WELCOME TO VOCABULARY TEST SECTION!!",Toast.LENGTH_SHORT).show();
                            }
