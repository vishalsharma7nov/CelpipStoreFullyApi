package com.celpipstore.CelpipTests.VocabularyTest;
...
import com.celpipstore.Adapter.VocabularyTestAdapter.VocabularyTestQuestionAdapter;
import com.celpipstore.JsonData.VocabularyTest.JsonDataHandlerVocabularyTestQuestionList;
...
public class VocabularyTestQuestionsActivity extends AppCompatActivity {
    ...
    private Button buttonSubmit,buttonNext,buttonViewReport,buttonDone,buttonBack,buttonFinish;
    private TextView textViewQuestion,textViewGivenAnswer,textViewCorrectAnswer;
    private RadioGroup radioGroupOptions;
    private RadioButton radioButtonOption1,radioButtonOption2,radioButtonOption3,radioButtonOption4;
    private String url;
    private int position =0;
    private JsonDataHandlerVocabularyTestQuestionList jsonHolderListing;
    private LinearLayout questionLayout,viewReportLayout;
...
//        Log.d("url", url);
    ...
    protected void exitByBackKey() {
        AlertDialog alertbox = new AlertDialog.Builder(this)
                .setMessage("DO YOUR WANT TO EXIT?")
                ...
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            {
                                loading.dismiss();
                                Toast.makeText(VocabularyTestQuestionsActivity.this, "VOCABULARY TESTS NOT AVAILABLE RIGHT NOW!! ", Toast.LENGTH_SHORT).show();
                            }
                            else if (abc == 1)
                            {
                                loading.dismiss();
                                showJSON(response);
                                Toast.makeText(getApplicationContext(), "WELCOME TO VOCABULARY TEST!!", Toast.LENGTH_SHORT).show();
                            }
