...
public class SpeakingTestPart3 {
    private String id;
    ...
    public SpeakingTestPart3(String id, String test_code, String q1_question, String q1_image, String created_date, String updated_date, String added_by, String role) {
        this.id = id;
