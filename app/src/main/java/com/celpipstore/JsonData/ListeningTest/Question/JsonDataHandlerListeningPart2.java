...
public class JsonDataHandlerListeningPart2 {
    ...
    private List<ListeningTestPart2> listeningTestPart2 = new ArrayList<>();
    ...
    public List<ListeningTestPart2> parseJSON() {
        try {
