...
public class JsonDataHandlerListeningPart3 {
    private List<ListeningTestPart3> listeningTestPart3 = new ArrayList<>();
    ...
    public List<ListeningTestPart3> parseJSON() {
        try {
