...
public class JsonDataHandlerListeningPart4 {
    private List<ListeningTestPart4> listeningTestPart4 = new ArrayList<>();
    ...
    private String json;
    public JsonDataHandlerListeningPart4(String json) {
        this.json = json;
    }

    public List<ListeningTestPart4> parseJSON() {
        try {
