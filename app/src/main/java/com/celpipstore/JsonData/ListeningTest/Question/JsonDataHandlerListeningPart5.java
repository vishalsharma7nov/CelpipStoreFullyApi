...
public class JsonDataHandlerListeningPart5 {
    private List<ListeningTestPart5> listeningTestPart5 = new ArrayList<>();
    ...
    public List<ListeningTestPart5> parseJSON() {
        try {
