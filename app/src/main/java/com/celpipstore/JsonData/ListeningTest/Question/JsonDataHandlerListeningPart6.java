...
public class JsonDataHandlerListeningPart6 {
    private List<ListeningTestPart6> listeningTestPart6 = new ArrayList<>();
    ...
    public List<ListeningTestPart6> parseJSON() {
        try {
