...
public class JsonDataHandlerReadingPart1 {
    private List<ReadingTestPart1> readingTestPart1 = new ArrayList<>();
    ...
    public List<ReadingTestPart1> parseJSON() {
        try {
