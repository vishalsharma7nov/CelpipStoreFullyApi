...
public class JsonDataHandlerReadingPart3 {
    private List<ReadingTestPart3> readingTestPart3 = new ArrayList<>();
    ...
    public List<ReadingTestPart3> parseJSON() {
        try {
