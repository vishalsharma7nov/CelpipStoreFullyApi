...
public class JsonDataHandlerReadingPart4 {
    private List<ReadingTestPart4> readingTestPart4 = new ArrayList<>();
    ...
    public JsonDataHandlerReadingPart4(String json) {
        this.json = json;
    }

    public List<ReadingTestPart4> parseJSON() {
        try {
