...
private void sendRequest() {
                ...
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (abc !=1 )
                            {
                                Toast.makeText(READING.this, "Maintance....", Toast.LENGTH_SHORT).show();
                            }
                            else if (abc == 1)
                            {
                                loading.dismiss();
    ...
    private void showJSON(String json) {
        ...
        ReadingTestAdapter ca = new ReadingTestAdapter(this,jsonHolderListing.id,jsonHolderListing.PTEsubtype, jsonHolderListing.coin_cost,jsonHolderListing.total_test);
