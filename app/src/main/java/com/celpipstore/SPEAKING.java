...
public class SPEAKING extends AppCompatActivity{
                ...
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (abc !=1 )
                            {
                                Toast.makeText(SPEAKING.this, "Work in Progress....", Toast.LENGTH_SHORT).show();
                            }
                            else if (abc == 1)
                            {
                                loading.dismiss();
    ...
    private void showJSON(String json) {
        ...
        SpeakingTestAdapter ca = new SpeakingTestAdapter(this,jsonHolderListing.id,jsonHolderListing.PTEsubtype, jsonHolderListing.coin_cost,jsonHolderListing.total_test);
