...
public class OurFeature extends AppCompatActivity
    ...
    private void navigation() {
        ...
        expListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v,
                ...
                if(groupPosition == 0 )
                {
                    Intent intent = new Intent(OurFeature.this, HOME.class);
                ...
                {
                    Intent intent = new Intent(OurFeature.this, WHYUS.class);
                    startActivity(intent);
                }
                else if(groupPosition == 3 )
                {
                    Intent intent = new Intent(OurFeature.this,OurFeature.class);
                    startActivity(intent);
                }
                else if(groupPosition == 4 )
                {
                    Intent intent = new Intent(OurFeature.this, FAQ.class);
                    startActivity(intent);
                }
                else if(groupPosition == 5 )
                {
                    Intent intent = new Intent(OurFeature.this, AboutUS.class);
                    startActivity(intent);
                }
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if(childPosition == 0)
                {
                    Intent intent = new Intent(OurFeature.this, LoginActivity.class);
                    startActivity(intent);
                }
                else if(childPosition == 1)
                {
                    Intent intent = new Intent(OurFeature.this, RegistrationActivity.class);
                    startActivity(intent);
                }
                return false;
            }
